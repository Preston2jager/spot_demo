...
class SpotStreamer:
    ...
    def _stream_loop(self):
        ...
        reqs = [
            build_image_request(src, pixel_format=image_pb2.Image.PIXEL_FORMAT_RGB_U8, quality_percent=70)   #type: ignore
        ...
        while self._streaming:
            try:
                ...
                for res in responses:
                    ...
                    if res.status == image_pb2.ImageResponse.STATUS_OK:  #type: ignore
