...
def load_map(path):
    ...
    with open(os.path.join(path, 'graph'), 'rb') as graph_file:
        ...
        for waypoint in current_graph.waypoints:
            ...
            # ===== 修改点 1：适配你的 wp_ 前缀平铺结构 =====
            file_name = os.path.join(path, f'wp_{waypoint.snapshot_id}')
            # ===============================================
        ...
        for edge in current_graph.edges:
            ...
            # ===== 修改点 2：适配你的 edge_ 前缀平铺结构 =====
            file_name = os.path.join(path, f'edge_{edge.snapshot_id}')
            # ===============================================
